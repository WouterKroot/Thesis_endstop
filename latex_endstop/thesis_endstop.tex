...
%ToDo: add a section on how I tried to implement ON and OFF streams endstopping. and why we need polarity invariance for stable endstopping
...
% The feedback from pattern cells makes it possible to integrate multiple weak inputs to a strong output, 

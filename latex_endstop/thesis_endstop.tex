...
% Add Kanizsa figure to the abutting grating, with mouse activity?
...
Cortical inactivation does not reduce orientation selectivity, suggesting that cortical feedback is not its source and inherited from subcortical structure \autocite{schollEmergenceOrientationSelectivity2013}. 

Overview models and physiology mouse and primate orientation selectivity  \autocite{priebeMechanismsOrientationSelectivity2016}

Early models lgn v1 convergence \autocite{hubelReceptiveFieldsBinocular1962}.

Model hebbian strengthening of connections \autocite{nguyenModelOriginDevelopment2019}.

\subsection{Models for illusory contour perception}

Models deep learning (Need for recurrency)
Models Filling In (Grossberg) (boundary points?)
How are boundary points represented in the cortex (endstopping) (Von der Heydt)
